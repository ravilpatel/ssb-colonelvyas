...
document.write( '        <a href=\"https://ssb.colonelvyas.org/TAT\" class=\"nav-link\">\n' );
document.write( '          <svg\n' );
document.write( '            aria-hidden=\"true\"\n' );
document.write( '            focusable=\"false\"\n' );
document.write( '            data-prefix=\"fad\"\n' );
...
document.write( '          <li>Take 60-65 minutes for attempting the mock for TAT.</li>\n' );
...
document.write( '          <li>TEST WILL START IMMEDIATELY WHEN YOU CLICK ON "GET STARTED" AND THEN PATIENTLY WAIT FOR INSTRUCTIONS BEFORE IMAGE COMES UP.</li>\n' );
document.write( '        </ul>\n' );
document.write( '      </div>\n' );
document.write( '      <div class=\"column5\">\n' );
...
document.write( '      <video id=\"video\" poster="tat-poster.png"  muted>\n' );
document.write( '        <source src=\"vid/3.mp4\" type=\"video/mp4\">\n' );
